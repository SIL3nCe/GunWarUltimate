...
public class PlayerCharacterControllerOld : MonoBehaviour
{
    ...
    private float m_fWallHangDirection = 0.0f;
    private float m_fHorizontalIntent = 0.0f;
    private float m_fHorizontalIntentDirection = 0.0f;
    ...
    void Update()
    {
        ...
        //
        //
        if (m_fHorizontalIntent > 0.0f)
        {
            m_fHorizontalIntent -= 1.0f;
        }
        else
        {
            m_fHorizontalIntent = 0.0f;
        }
    ...
    private void UpdateAir(float fPlayerInputHorizontal)
    {
        ...
        if (m_bFalling)
        {
            //m_vMoveDirection.x += fPlayerInputHorizontal * (m_fPlayerAirSpeed * 0.6f) * m_fGravityScale * Time.deltaTime;
            m_vMoveDirection.x = fPlayerInputHorizontal * m_fPlayerSpeed * Time.deltaTime;
        }
        else
        {
            //m_vMoveDirection.x += fPlayerInputHorizontal * m_fPlayerAirSpeed * m_fGravityScale * Time.deltaTime;
            m_vMoveDirection.x = fPlayerInputHorizontal * m_fPlayerSpeed * Time.deltaTime;
        }
        ...
        //    //
        //    // Store the direction of the wall (if we jump we will jump in the opposite direction
        //    if (m_vMoveDirection.x > 0.0f)
        //    {
        //        m_fWallHangDirection = -1.0f;
        //    }
        //    else
        //    {
        //        m_fWallHangDirection = 1.0f;
        ...
        //{
        //    m_vMoveDirection.y -= (m_fGravityScale / 8.0f) * Time.deltaTime;
        //}
        //else
        //{
        ...
        //        m_vMoveDirection.y = (m_fJumpScale * m_fPlayerAirSpeed) * Time.deltaTime;
        //        m_vMoveDirection.x = (m_fJumpScale * m_fWallHangDirection * m_fPlayerAirSpeed) * Time.deltaTime;
        //        m_bHangOnWall = false;
        //        //m_bWallJumping = true;
        ...
        if (!m_bAlreadyDoubleJumped)
        {
            if (Input.GetKeyDown(m_keyCodeJump))
            {
                m_fHorizontalIntent = 20.0f;
                m_fHorizontalIntentDirection = fPlayerInputHorizontal;
            }
        }

        m_vMoveDirection.x = fPlayerInputHorizontal * Time.deltaTime;
        m_vMoveDirection.x += m_fHorizontalIntent * m_fHorizontalIntentDirection * Time.deltaTime;
